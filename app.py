...
import os
import librosa
from PreProccesing import preprocess_audio  # Import your preprocessing functions
...
# Define MFCC extraction and padding functions
...
def predict():
    ...
    processed_audio = np.expand_dims(padded_mfcc, axis=0)  # Add batch dimension
